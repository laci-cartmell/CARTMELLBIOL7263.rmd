...
Principal Components Analysis (PCA) is the analysis of the principal components that explain a large portion of the variation in a dataset.

Principal components are linear combinations of the original predictors. Because of the orthogonal transformations the data undergoes, numerical data works the best. You could code categorical as continuous but better to use categorical variables later on for grouping (plus pretty colors)
...
It can also indicate when to use a 3-D PCA
